...
export class BuyAnalyst extends Analyst {
  ...
  constructor(readonly watcher: AssetWatcher, readonly config: BotConfig) {
    ...
    this.registerIndicator(false, 0.36, 240, 'UPTREND 4h', uptrend('4h', 240, 0.5))
    this.registerIndicator(false, 0.36, 240, 'RSI 4h', rsi('4h'))
    this.registerIndicator(false, 0.23, 240, 'STOCHF 4h', stochastic('4h'))
