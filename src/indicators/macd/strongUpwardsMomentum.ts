...
// We can be more confident if the MACD is still below the ZERO line.
// Meaning it might have more momentum left to go up vs if it would be already above ZERO.
